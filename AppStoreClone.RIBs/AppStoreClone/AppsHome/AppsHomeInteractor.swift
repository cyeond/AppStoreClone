    ...
    static let dummyData = [
        CollectionViewSectionModel(
            ...
            items: [
                ...
                CollectionViewItem(type: .appPreviewBasic(AppPreviewInfo(id: "368677368", title: "티맵 - 대중교통, 대리운전, 주차, 렌터카, 공항버스", subtitle: "당신의 이동능력, 티맵"))),
        ...
        CollectionViewSectionModel(
            ...
            items: [
                CollectionViewItem(type: .appPreviewBasic(AppPreviewInfo(id: "839333328", title: "토스", subtitle: "금융이 쉬워진다"))),
                CollectionViewItem(type: .appPreviewBasic(AppPreviewInfo(id: "", title: "트래블월렛 - TravelPay", subtitle: "페이에 세계를 담다"))),
                CollectionViewItem(type: .appPreviewBasic(AppPreviewInfo(id: "", title: "29CM", subtitle: "감도 깊은 취향 셀렉트샵"))),
                CollectionViewItem(type: .appPreviewBasic(AppPreviewInfo(id: "", title: "Goodnotes 6", subtitle: "새롭게 태어난 노트."))),
                CollectionViewItem(type: .appPreviewBasic(AppPreviewInfo(id: "", title: "Forest - 꿈을 향한 집중 타이머 & 스톱워치", subtitle: "스마트폰 중독에서 벗어나기"))),
            ]),
        CollectionViewSectionModel(
            section: CollectionViewSection(type: .groupThree(title: "지금 주목해야 할 앱", subtitle: "새로 나온 앱과 업데이트")),
            items: [
                CollectionViewItem(type: .appPreviewBasic(AppPreviewInfo(id: "", title: "타입플릭 TIMEFLIK 워치페이스", subtitle: "커스텀 워치페이스 & 스트랩"))),
                CollectionViewItem(type: .appPreviewBasic(AppPreviewInfo(id: "", title: "Goodnotes 6", subtitle: "새롭게 태어난 노트."))),
                CollectionViewItem(type: .appPreviewBasic(AppPreviewInfo(id: "", title: "PhotoWidget : Simple\n(포토위젯)", subtitle: "상상할 수 있는 모든 위젯: 테마, 배경화면, 아이콘"))),
                CollectionViewItem(type: .appPreviewBasic(AppPreviewInfo(id: "", title: "EPIK 에픽 - AI 사진 & 영상 편집", subtitle: "필터, 이펙트, 보정, 메이크업, 템플릿, AI"))),
                CollectionViewItem(type: .appPreviewBasic(AppPreviewInfo(id: "", title: "네이버웍스 - NAVER WORKS", subtitle: "네이버가 만든 업무용 협업도구"))),
            ]),
    ]
}
