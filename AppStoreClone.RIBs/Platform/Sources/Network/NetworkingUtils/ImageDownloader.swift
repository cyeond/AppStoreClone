...
public struct ImageDownloader {
    ...
    public static let imageDownloaderScheduler = ConcurrentDispatchQueueScheduler(queue: imageDownloaderQueue)
    
    public static func downloadImage(uriString: String) -> Single<UIImage> {
