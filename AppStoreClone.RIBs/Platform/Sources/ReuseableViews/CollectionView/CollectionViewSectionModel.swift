...
public struct CollectionViewSectionModel {
    public let section: CollectionViewSection
    public let items: [CollectionViewItem]
    
    public init(section: CollectionViewSection, items: [CollectionViewItem]) {
    ...
    public func layoutSection() -> NSCollectionLayoutSection {
        switch self.section.type {
        case .groupedThree(title: _, subtitle: _):
